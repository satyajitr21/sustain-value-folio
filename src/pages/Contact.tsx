  ...
  async function onSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      if (r.ok) {
        ...
        setError(
          j?.errors?.[0]?.message || "Submission failed. Please try again."
        );
        setStatus("err");
      }
    } catch {
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-academic-body max-w-4xl mx-auto leading-relaxed">
            I welcome opportunities for collaboration, academic discussions, and
            professional networking. Please feel free to reach out for research
            partnerships, teaching/speaking engagements, or academic
            consultations.
          </p>
        </div>
            ...
            <Card className="shadow-academic-card">
              ...
              <CardContent className="space-y-6">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="font-semibold text-academic-subheading mb-1">
                      Academic Email
                    </h3>
                    <a
              ...
              <CardContent className="space-y-4">
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <h4 className="font-medium text-academic-subheading">
                        LinkedIn
                      </h4>
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-academic-body text-sm">
                        Research identity and publications
                      </p>
                    </div>
                  </div>
                  <ExternalLink className="h-4 w-4 text-academic-caption" />
              ...
              <CardContent>
                <div className="space-y-3">
                  <div className="flex items-start">
                    ...
                    <p className="text-academic-body">
                      Interdisciplinary collaborations to advance social and
                  ...
                  <div className="flex items-start">
                    <div className="w-2 h-2 bg-primary rounded-full mt-2 mr-3 flex-shrink-0"></div>
                    <p className="text-academic-body">
                      Industry consulting on supply chain sustainability
                    </p>
                  </div>
                  <div className="flex items-start">
                    <div className="w-2 h-2 bg-primary rounded-full mt-2 mr-3 flex-shrink-0"></div>
                    <p className="text-academic-body">
                      Academic mentoring and PhD guidance
                    </p>
                  </div>
                </div>
              </CardContent>
          ...
          <div>
            <Card className="shadow-academic-card">
              <CardHeader>
                ...
                <p className="text-academic-body">
                  Use this form for quick inquiries. I typically respond within
                  24-48 hours.
                </p>
              </CardHeader>
              <CardContent>
                <form className="space-y-6" onSubmit={onSubmit}>
                  ...
                  <div className="mt-6 bg-muted/30 rounded-lg p-4">
                    <h3 className="font-semibold text-academic-subheading mb-2">
                      Response Time
                    </h3>
                    <p className="text-academic-body text-sm leading-relaxed">
                      ...
                      "URGENT" in your subject line. During conference travel or
                      research field work, responses may take longer.
                    </p>
                  </div>
                </form>
              </CardContent>
        ...
        <section className="mt-16 bg-muted/30 rounded-2xl p-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div>
              <h3 className="font-semibold text-academic-subheading mb-4">
                Student Office Hours
              </h3>
              <div className="space-y-2 text-academic-body">
                <p>
                  <strong>Thursdays:</strong> 5:00-6:00 PM
                </p>
                <p>
                  <strong>Fridays:</strong> 4:00-5:00 PM
                </p>
            ...
            <div>
              ...
              <div className="space-y-2 text-academic-body">
                <p>
                  <strong>Academic Collaborations:</strong> By appointment
                </p>
                <p>
                  <strong>Industry Consultations:</strong> Flexible scheduling
                </p>
                <p className="text-sm text-academic-caption">
